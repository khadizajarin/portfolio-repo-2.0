...
const Banner = ({contactRef}) => { 
    ...
    return (
        <div className="flex justify-center items-center lg:flex-row-reverse md:flex-row-reverse flex-col-reverse bg-[#1E3660] lg:h-[42.625rem] md:h-[20rem] ">
                ...
                <div className="lg:w-full bg-white ">
                    ...
                    {/* right border */}
                    <div className="relative">
                        <div className="absolute lg:right-[5.6875rem] right-[2rem] z-10   "> 
                    ...
                    <div className="relative">
                        <div className="absolute lg:-left-[2.8125rem] left-[2rem] z-10  " > 
                                ...
                                <div className="hidden lg:inline-block mt-[36.75rem] border-l-[3px] border-white md:opacity-70 h-14 absolute"></div>
                        </div>
                    </div>


                    {/* the image */}
                    <img src={image} className="lg:w-[42.75rem] w-full md:h-full lg:mb-[0.19rem] "  />


                    {/* bottom border */}
                    <div className="relative">
                        <div className="flex z-10 justify-center items-center absolute lg:ml-0 ml-[2rem] lg:bottom-[2.25rem] bottom-[1rem]" >
                            ...
                            <div className="hidden lg:inline border-b-[3px] border-white md:opacity-70 w-[5rem] ml-5"></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:w-[118.3%] lg:ml-[14.5rem]  flex flex-col justify-center items-start mb-16 mt-10 lg:mt-0">
                    <div className=" ">
                        ...
                        <div className="relative">
                            <div className="absolute lg:top-[10.5rem] top-[1.99rem] lg:left-[12.8rem] flex flex-col justify-center items-center">
