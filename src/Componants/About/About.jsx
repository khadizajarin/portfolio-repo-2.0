...
const About = () => {
    return (
        <div className="relative flex flex-col items-center bg-white ">
            ...
            {/* <div className="absolute h-full w-1 bg-[#768B9C] opacity-[0.09] lg:opacity-15 lg:right-[30.1875rem] right-16"></div> */}
            <div className="absolute h-20 w-1 bg-[#768B9C] opacity-[0.09] lg:opacity-15  lg:right-[30.1875rem] right-16"></div>
            ...
            <div className="flex flex-col justify-center items-center lg:mt-16 mt-10">
                ...
                Hey there, I'm Khadiza Jarin Roza, a Frontend focused React Developer with a strong passion for creating sleek,
                <span className="hidden lg:inline"><br /></span> user-friendly interfaces. Through an intensive 6-month course, I've mastered
                <span className="hidden lg:inline"><br /></span> React and a comprehensive suite of front-end technologies. <span className="lg:hidden inline"><br /> <br /></span> I thrive on transforming
                ...
                <span className="hidden lg:inline"><br /></span> innovative challenges and fully embrace the dynamic and ever-changing <span className="hidden lg:inline"><br /></span> landscape of design and coding. 
